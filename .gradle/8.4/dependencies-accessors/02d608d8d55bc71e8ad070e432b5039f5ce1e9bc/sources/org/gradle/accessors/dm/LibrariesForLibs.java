...
public class LibrariesForLibs extends AbstractExternalDependencyFactory {
    ...
    private final SmoothLibraryAccessors laccForSmoothLibraryAccessors = new SmoothLibraryAccessors(owner);
    ...
    /**
     * Returns the group of libraries at smooth
     */
    public SmoothLibraryAccessors getSmooth() {
        return laccForSmoothLibraryAccessors;
    }
    ...
    public static class SmoothLibraryAccessors extends SubDependencyFactory {
        private final SmoothBottomLibraryAccessors laccForSmoothBottomLibraryAccessors = new SmoothBottomLibraryAccessors(owner);

        public SmoothLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

        /**
         * Returns the group of libraries at smooth.bottom
         */
        public SmoothBottomLibraryAccessors getBottom() {
            return laccForSmoothBottomLibraryAccessors;
        }

    }

    public static class SmoothBottomLibraryAccessors extends SubDependencyFactory {

        public SmoothBottomLibraryAccessors(AbstractExternalDependencyFactory owner) { super(owner); }

            /**
             * Creates a dependency provider for bar (com.github.ibrahimsn98:SmoothBottomBar)
             * This dependency was declared in catalog libs.versions.toml
             */
            public Provider<MinimalExternalModuleDependency> getBar() {
                return create("smooth.bottom.bar");
        }
